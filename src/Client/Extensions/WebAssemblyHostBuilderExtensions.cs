...
using VoteApp.Client.Infrastructure.Authentication;
using VoteApp.Client.Infrastructure.Managers;
using VoteApp.Client.Infrastructure.Managers.Preferences;
...
namespace VoteApp.Client.Extensions
{
