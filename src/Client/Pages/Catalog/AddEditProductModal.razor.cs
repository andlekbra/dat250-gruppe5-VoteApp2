...
using VoteApp.Client.Infrastructure.Managers.Catalog.Brand;
using VoteApp.Client.Infrastructure.Managers.Catalog.Product;

namespace VoteApp.Client.Pages.Catalog
{
