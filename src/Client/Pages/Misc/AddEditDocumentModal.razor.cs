...
using VoteApp.Client.Infrastructure.Managers.Misc.Document;
using VoteApp.Client.Infrastructure.Managers.Misc.DocumentType;

namespace VoteApp.Client.Pages.Misc
{
