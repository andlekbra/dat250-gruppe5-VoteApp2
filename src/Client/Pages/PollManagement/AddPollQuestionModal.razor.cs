...
{
    public partial class AddPollQuestionModal
    {
        [Inject] private IPollQuestionManager PollQuestionManager { get; set; }

        [Parameter] public AddPollQuestionCommand AddPollQuestionCommand { get; set; } = new();
        ...
        {
            var response = await PollQuestionManager.SaveAsync(AddPollQuestionCommand);
