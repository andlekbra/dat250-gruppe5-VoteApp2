...
using VoteApp.Application.Features.ExtendedAttributes.Commands.Delete;
using VoteApp.Application.Features.ExtendedAttributes.Queries.Export;
using VoteApp.Application.Features.ExtendedAttributes.Queries.GetAll;
using VoteApp.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using VoteApp.Application.Features.ExtendedAttributes.Queries.GetById;
using VoteApp.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace VoteApp.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
