...
using VoteApp.Application.Features.DocumentTypes.Commands.Delete;
using VoteApp.Application.Features.DocumentTypes.Queries.Export;
...
namespace VoteApp.Server.Controllers.Utilities.Misc
{
